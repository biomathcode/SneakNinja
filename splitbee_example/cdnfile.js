var splitbee = (function (e) {
    ...
    a = function (e) {
      ...
      return n(void 0, void 0, Promise, function () {
        ...
        return r(this, function (r) {
          switch (r.label) {
            case 0:
              if (C || R) return [2, { response: void 0 }];
              (e = B()),
                (n = i()),
                (s = document.referrer),
                (l =
                ...
                [
                  ...
                  fetch(D + a, {
                    ...
                    headers: t(
                      ...
                      { "context-id": d(), "x-origin": document.location.href }
                    ),
                    body: JSON.stringify(
                      t(t({}, c), l && !o && u && { referrer: l })
                    ),
                  }),
                ]
              );
            ...
            case 3:
              return (
                ...
                _(h),
                h && !I && q(h),
                [2, { response: v || {}, statusCode: f.status }]
              );
            case 4:
  ...
  var H = function (e) {
              ...
              return (
                ...
                [
                  ...
                  a({
                    path: "/i",
                    setReferrer: !0,
                    body: t({ origin: window.location.href }, e && { eid: e }),
                  }),
                ]
              );
            case 2:
    ...
    K = new WeakMap(),
    W = function (e, t) {
      return a({ path: "/t", body: { event: e, data: t } });
    },
    $ = {
      set: function (e) {
        var t = e.id,
          n = e.email,
          r = e.userId || t || n;
        r && !i() && j("_userId", r), a({ path: "/user", body: e });
      },
    };
